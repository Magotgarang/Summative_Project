...
// A Min Heap: Collection of min-heap (or Hufman tree) nodes
struct MinHeap {
    unsigned size;
    unsigned capacity;
...
// It initially sizes of min heap equal to capacity
...
// Main function that builds a Huffman Tree and prints codes
...
void compressFile(const char *inputFile, const char *outputFile) {
    ...
    // (Add more code to compress the file using Huffman encoding)
...
void decompressFile(const char *inputFile, const char *outputFile) {
    // (Add code to decompress the file)
}
